    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDoSomethingCoolButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                // OK (1) Retrieve the text from the EditText and store it in a variable

                String textNameEntry = mNameEntry.getText().toString();
                ...
                // OK (2) Use the putExtra method to put the String from the EditText in the Intent

                startChildActivityIntent.putExtra(Intent.EXTRA_TEXT, textNameEntry);
