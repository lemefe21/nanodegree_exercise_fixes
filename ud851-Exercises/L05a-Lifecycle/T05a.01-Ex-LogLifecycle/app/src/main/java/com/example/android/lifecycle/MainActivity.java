...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // OK (1) Use logAndAppend within onCreate

        logAndAppend("onCreate");

    }

    // OK (2) Override onStart, call super.onStart, and call logAndAppend with ON_START

    // OK (3) Override onResume, call super.onResume, and call logAndAppend with ON_RESUME

    // OK (4) Override onPause, call super.onPause, and call logAndAppend with ON_PAUSE

    // OK (5) Override onStop, call super.onStop, and call logAndAppend with ON_STOP

    // OK (6) Override onRestart, call super.onRestart, and call logAndAppend with ON_RESTART

    // OK (7) Override onDestroy, call super.onDestroy, and call logAndAppend with ON_DESTROY
