...
public class MainActivity extends AppCompatActivity {
     ...
     * being posted.
     */
    private static final String TAG = "lifecycleTextKey";

    // OK (1) Create a key String called LIFECYCLE_CALLBACKS_TEXT_KEY
    private static final String LIFECYCLE_CALLBACKS_TEXT_KEY = "lifecycleTextKey";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // OK (6) If savedInstanceState is not null and contains LIFECYCLE_CALLBACKS_TEXT_KEY, set that text on our TextView

        if(savedInstanceState != null){
            if(savedInstanceState.containsKey(LIFECYCLE_CALLBACKS_TEXT_KEY)){
                logAndAppend("containsKey = LIFECYCLE_CALLBACKS_TEXT_KEY");
    ...
    // OK (2) Override onSaveInstanceState
    // Do steps 3 - 5 within onSaveInstanceState
    // OK (3) Call super.onSaveInstanceState
    // OK (4) Call logAndAppend with the ON_SAVE_INSTANCE_STATE String
    // OK (5) Put the text from the TextView in the outState bundle
