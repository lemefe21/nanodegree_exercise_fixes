...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenWebpageButton(View v) {
        // OK (5) Create a String that contains a URL ( make sure it starts with http:// or https:// )

        String urlUdacity = "https://www.udacity.com";

        // OK (6) Replace the Toast with a call to openWebPage, passing in the URL String from the previous step
    ...
    // OK (1) Create a method called openWebPage that accepts a String as a parameter
    // Do steps 2 - 4 within openWebPage

        // OK (2) Use Uri.parse to parse the String into a Uri

        // OK (3) Create an Intent with Intent.ACTION_VIEW and the webpage Uri as parameters
