...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        // OK (1) Check if you are on Android M or later, if so...
            // OK (2) Get a BatteryManager instance using getSystemService()
            // OK (3) Call isCharging on the battery manager and pass the result on to your show
            // charging method
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            //sticky intent >> Intent.ACTION_BATTERY_CHANGED

            IntentFilter intentFilter = new IntentFilter(Intent.ACTION_BATTERY_CHANGED);
            Intent intentBatteryStatus = registerReceiver(null, intentFilter);

            int batteryStatus = intentBatteryStatus.getIntExtra(BatteryManager.EXTRA_STATUS, -1);
        ...
        // OK (4) If your user is not on M+, then...
            // OK (5) Create a new intent filter with the action ACTION_BATTERY_CHANGED. This is a
            // sticky broadcast that contains a lot of information about the battery state.
            // OK (6) Set a new Intent object equal to what is returned by registerReceiver, passing in null
            ...
            // OK (7) Get the integer extra BatteryManager.EXTRA_STATUS. Check if it matches
            // BatteryManager.BATTERY_STATUS_CHARGING or BatteryManager.BATTERY_STATUS_FULL. This means
            // the battery is currently charging.
            // OK (8) Update the UI using your showCharging method
