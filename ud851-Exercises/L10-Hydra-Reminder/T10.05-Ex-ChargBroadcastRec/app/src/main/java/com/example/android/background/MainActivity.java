...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // OK (5) Create and instantiate a new instance variable for your ChargingBroadcastReceiver
        // and an IntentFilter

        // OK (6) Call the addAction method on your intent filter and add Intent.ACTION_POWER_CONNECTED
    ...
    // OK (7) Override onResume and setup your broadcast receiver. Do this by calling
    ...
    // OK (8) Override onPause and unregister your receiver using the unregisterReceiver method
    @Override
    ...
    // OK (1) Create a new method called showCharging which takes a boolean. This method should
    ...
    public void showCharging(boolean isDevideCharging) {

        //mChargingImageView << image view
    ...
    // OK (2) Create an inner class called ChargingBroadcastReceiver that extends BroadcastReceiver
        // OK (3) Override onReceive to get the action from the intent and see if it matches the
        // Intent.ACTION_POWER_CONNECTED. If it matches, it's charging. If it doesn't match, it's not
        // charging.
        // OK (4) Update the UI using the showCharging method you wrote
}