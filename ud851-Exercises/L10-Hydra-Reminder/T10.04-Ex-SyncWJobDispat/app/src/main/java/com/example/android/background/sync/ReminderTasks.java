...
public class ReminderTasks {
    ...
    private static void issueChargingReminder(Context context) {
        ...
        PreferenceUtilities.incrementChargingReminderCount(context); //count of charging
        NotificationUtils.remindUserBecauseCharging(context); //show notification
    ...
    // OK (2) Create an additional task for issuing a charging reminder notification.
