...
public class ReminderUtilities {
    ...
    // OK (15) Create three constants and one variable:
    ...
    synchronized public static void scheduleChargingReminder(final Context context) {
        ...
        Log.i("Test","ReminderUtilities - scheduleChargingReminder");
        ...
        Job constraintReminderJob = dispatcher.newJobBuilder()
                ...
                .setConstraints(Constraint.DEVICE_CHARGING) //only if device is charging
    ...
    // OK (16) Create a synchronized, public static method called scheduleChargingReminder that takes
    ...
    // Checkout https://github.com/firebase/firebase-jobdispatcher-android for an example
        // OK (17) If the job has already been initialized, return
        // OK (18) Create a new GooglePlayDriver
        // OK (19) Create a new FirebaseJobDispatcher with the driver
        // OK (20) Use FirebaseJobDispatcher's newJobBuilder method to build a job which:
        ...
        // OK (21) Use dispatcher's schedule method to schedule the job
        // OK (22) Set sInitialized to true to mark that we're done setting up the job
}
