...
//  OK (1) Implement the delete method of the ContentProvider
    /**
...
//      OK (2) Only implement the functionality, given the proper URI, to delete ALL rows in the weather table
//      OK (3) Return the number of rows deleted
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case CODE_WEATHER:
                ...
                weathersDeleted = db.delete(WeatherContract.WeatherEntry.TABLE_NAME, selection, selectionArgs);
