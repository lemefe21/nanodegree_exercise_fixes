...
//  OK (1) Declare a private static boolean field called sInitialized

    //  OK (2) Create a synchronized public static void method called initialize
    //  OK (3) Only execute this method body if sInitialized is false
    //  OK (4) If the method body is executed, set sInitialized to true
    //  OK (5) Check to see if our weather ContentProvider is empty
        //  OK (6) If it is empty or we have a null Cursor, sync the weather now!
