...
//  OK (1) Create a constant int value to identify the notification
    public static final int WEATHER_NOTIFICATION_ID = 1000;
    ...
    public static void notifyUserOfNewWeather(Context context) {
        ...
        if (todayWeatherCursor.moveToFirst()) {
            ...
            * forecast.
            */
//          OK (2) Use NotificationCompat.Builder to begin building the notification
...
//          OK (3) Create an Intent with the proper URI to start the DetailActivity
            /*
...
//          OK (4) Use TaskStackBuilder to create the proper PendingIntent
            TaskStackBuilder taskStackBuilder = TaskStackBuilder.create(context);
            taskStackBuilder.addNextIntentWithParentStack(detailIntentForToday);
            PendingIntent pendingIntent = taskStackBuilder.getPendingIntent(0, PendingIntent.FLAG_UPDATE_CURRENT);

//          OK (5) Set the content Intent of the NotificationBuilder
            notificationBuilder.setContentIntent(pendingIntent);

//          OK (6) Get a reference to the NotificationManager
            NotificationManager notificationManager = (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);

//          OK (7) Notify the user with the ID WEATHER_NOTIFICATION_ID
            /* WEATHER_NOTIFICATION_ID allows you to update or cancel the notification later on */
            notificationManager.notify(WEATHER_NOTIFICATION_ID, notificationBuilder.build());

//          OK (8) Save the time at which the notification occurred using SunshinePreferences
            /*
