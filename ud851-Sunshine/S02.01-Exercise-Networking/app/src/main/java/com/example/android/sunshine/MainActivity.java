...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // OK (4) Delete the dummy weather data. You will be getting REAL data from the Internet in this lesson.
        /*
        ...
        // OK (3) Delete the for loop that populates the TextView with dummy data
        /*
    ...
    // OK (8) Create a method that will get the user's preferred location and execute your new AsyncTask and call it loadWeatherData

    public void loadWeatherData() {

        String preferredWeatherLocation = SunshinePreferences.getPreferredWeatherLocation(this);
        Log.v(TAG, "SunshinePreferences: " + preferredWeatherLocation);
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                ...
                //get list of weathers in json body
                String[] simpleWeatherStringsFromJson = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, jsonWeatherResponse);
        ...
        protected void onPostExecute(String[] weatherData ) {
            ...
            //set list of weathers in activity

            Log.v(TAG, "onPostExecute: " + weatherData);

            if(weatherData != null) {
                for (String data: weatherData) {
                    Log.v(TAG, "List of weatherData: " + data);
