...
//      OK (15) Remove the implements declaration for SharedPreferences change listener and methods
//      OK (20) Implement LoaderCallbacks<Cursor> instead of String[]


    private final String TAG = MainActivity.class.getSimpleName();

    //  OK (16) Create a String array containing the names of the desired data columns from our ContentProvider
    ...
    //  OK (17) Create constant int values representing each column name's position above
...
//  OK (37) Remove the error TextView
    ...
    //  OK (35) Remove the preference change flag
...
//      OK (36) Remove the findViewById call for the error TextView
...
//      OK (4) Pass in this again as the ForecastAdapter now requires a Context
        /*
...
//      OK (18) Call the showLoading method
        showLoading();
...
//      OK (19) Remove the statement that registers Mainactivity as a preference change listener
...
//      OK (23) Remove the onStartLoading method declaration
//      OK (24) Remove the loadInBackground method declaration
//      OK (25) Remove the deliverResult method declaration
//      OK (22) If the loader requested is our forecast loader, return the appropriate CursorLoader
...
//  OK (26) Change onLoadFinished parameter to a Loader<Cursor> instead of a Loader<String[]>
    /**
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        //      OK (28) Call mForecastAdapter's swapCursor method and pass in the new Cursor
        mForecastAdapter.swapCursor(data);

        //      OK (29) If mPosition equals RecyclerView.NO_POSITION, set it to 0
